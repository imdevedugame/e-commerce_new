                                    ...
                                    <div class="product-image-slider">
                                        @foreach ($product->images as $img)
                                            <figure class="border-radius-10">
                                                <img src="{{ asset('storage/'.$img) }}" alt="gambar produk">
                                            </figure>
                                        @endforeach
                                    </div>
                                    <!-- THUMBNAILS -->
                                ...
                                <div class="detail-info">
                                    ...
                                    <div class="clearfix product-price-cover">
                                        <div class="product-price primary-color float-left">
                                            ...
                                            <ins><span
                                                    class="old-price font-md ml-15">Rp{{ number_format($product->old_price, 0, ',', '.') }}</span></ins>
                                        </div>
                                    </div>
                                    ...
                                    <div class="product_sort_info font-xs mb-30">
                                        <ul>
                                            <li class="mb-10"><i class="fi-rs-crown mr-5"></i> Garansi 7 hari</li>
                                            <li class="mb-10"><i class="fi-rs-refresh mr-5"></i> Kebijakan Pengembalian 1 Hari</li>
                                            <li><i class="fi-rs-credit-card mr-5"></i> Pembayaran di Tempat tersedia</li>
                                        </ul>
                                    </div>
                                        ...
                                        <li>Ketersediaan:
                                            @if ($product->stock_status === 'instock')
                                                <span class="in-stock text-success ml-5">{{ $product->quantity }}
                                                    Barang Tersedia</span>
                                            @else
                                                <span class="out-stock text-danger ml-5">Habis</span>
                                            @endif
                                        </li>
                                    </ul>
                                </div>
